...
import com.example.thietkebanh.databinding.ItemChooseImageBinding;
import com.example.thietkebanh.utils.Constants;
...
public class ChooseImageAdapter extends RecyclerView.Adapter<ChooseImageAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChooseImageAdapter.ViewHolder holder, int position) {
